...
print("\n~~~~~~~~~~~~~~~~~~~~~~~~~~")
print("\nJignore les variables : Make, Model year, Model, City (L/100 km), "
...
print(" -Model year: Comme vu dans my_stat les émissions de CO2 sont stables "
      "par année de fabrication")
print("Model : Ca n'aurait pas de sens de l'utiliser ici")
print(" -Highway et City : Utiliser City , Highway et Combined (L/100 km) peut donner "
      "un poids disproportionné à la consommation par rapport aux autres variable,")
...
print(" -CO2 Rating : Cette variable est dérivée des émissions de CO2 "
      "et dépendt donc déjà de notre cible")
print(" -Smog rating : trop de données manquantes")
...
print(f"\nJe supprime les colonnes {constant_columns.to_list()} "
      "car elles sont quasi-constantes")
